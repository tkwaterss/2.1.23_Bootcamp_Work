...
// CODE HERE
uniq(names,uniqueArray = (uniqArr) => {
...
// CODE HERE
each(names, listArray = (item, index) => {
...
// CODE HERE
const addingFactory = (num1) => (num2) => console.log(num1 + num2);
...
// CODE HERE 
const getUserById = (objArray,idNumber,callback) => {
  for(let i = 0; i < objArray.length; i++) {
    if (idNumber === objArray[i].id) {
      callback(objArray[i]);
    }
  }
